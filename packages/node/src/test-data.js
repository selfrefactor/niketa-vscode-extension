...
export const throwingSyncTest = resolve(__dirname, '../test-data/failed-code/sync.js')
export const throwingAsyncTest = resolve(__dirname, '../test-data/failed-code/async.js')
